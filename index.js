...
bot.on("message", message => {
  if (message.channel.id === "661627415109304341") { //This will make the bot work only in that channel
        ...
        fs.readFile(filePath, function(err, data) {
          if (!err) {
            ...
            if (position != -1) {
              ...
              message.channel.send(
                "Sorry, there isn't any account avaliable for that service!"
              );
            }
          } else {
            message.channel.send(
...
bot.login("NjYxNjI3MDAyMzA2MDM1NzE3.XguKLw.S_PDeYq7gIYOvnoWc_SUyag6vXU");
